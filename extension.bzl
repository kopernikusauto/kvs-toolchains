...
def _kvs_toolchain_archives_impl(ctx):
    ...
    http_archive(
        ...
        build_file = "//toolchain/archives:tricore_gcc_11.3.1.BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "//toolchain/archives:aurix_flasher.BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "//toolchain/archives:llvm_mingw_ucrt.BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "//toolchain/archives:gcc_linux_x86_64_13.2.0.BUILD",
    )
